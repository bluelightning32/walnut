...
TEST(ConvexPolygon, GetProjectedAreaDifferentDenomsRectangle) {
  // Rectangle that is 3 wide and 5 tall.
  std::vector<HomoPoint3> input{
...
TEST(ConvexPolygon, GetProjectedCentroidRectangle) {
  // Rectangle that is 3 wide and 5 tall.
  Point3 input[] = {
    Point3(2, 2, 10),
    Point3(5, 2, 10),
  ...
  EXPECT_EQ(polygon.GetProjectedCentroid(/*drop_dimension=*/2),
            HomoPoint2(2 + 5, 2 + 7, 2));
}

TEST(ConvexPolygon, GetProjectedCentroidRectangleClockwise) {
  // Rectangle that is 3 wide and 5 tall.
  Point3 input[] = {
    Point3(2, 7, 10),
    Point3(5, 7, 10),
...
TEST(ConvexPolygon, GetProjectedCentroidSameDenomRectangle) {
  // Rectangle that is 3 wide and 5 tall.
  std::vector<HomoPoint3> input{
    HomoPoint3(20, 20, 0, 10),
    HomoPoint3(50, 20, 0, 10),
...
TEST(ConvexPolygon, GetProjectedCentroidDifferentDenomsRectangle) {
  // Rectangle that is 3 wide and 5 tall.
  std::vector<HomoPoint3> input{
    HomoPoint3(10, 10, 0, 5),
    HomoPoint3(10, 4, 0, 2),
